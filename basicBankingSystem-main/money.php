...
<body>
    ...
    <nav class="navbar py-2 navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">THE FOUNDATION BANK GROUP <img src="logos/logo.webp" alt="Bank" width="50" height="50"></a>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr style="color : black;">
                                    ...
                                    <td><a href="users.php?id= <?php echo $rows['id']; ?>"> <button class="btn btn-outline-dark btn">View</button></a></td>
                                </tr>
                            <?php
                            }
                            ?>
